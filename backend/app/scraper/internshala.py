...
def scrape_internshala():
    ...
    url = 'https://internshala.com/internships/work-from-home-android-app-development,data-science,flutter-development,mobile-app-development,node-js-development,web-development-internships-in-mumbai/'
